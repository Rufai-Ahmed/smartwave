...
const BestSelling: FC<{ heading?: boolean }> = ({ heading }) => {
  return (
    <div className="col-span-4 xl:col-span-1">
      ...
      <section
        className={`w-full border rounded-[10px] p-3 flex flex-col justify-between border-gray-500 h-[270px] `}
      >
        ...
        <div className="grid gap-2 grid-cols-2">
          <Button className=" text-[14px] md:text-[15px] h-auto md:h-auto w-full 2xl:w-full md:w-full">
            Lorem, ipsum.
          </Button>
