    ...
    <main className="items-start bg-white text-[#D9D9D9] dark:bg-dark grid grid-cols-2">
      ...
      <div className="min-h-screen w-full text-center col-span-2 lg:col-span-1 flex items-center justify-center">
        <div className="flex flex-col justify-center items-center min-h-screen w-[90%]">
          <div className="w-[300px] md:w-[450px] scale-75 md:scale-90 text-[#F2F2F2] md:bg-[#191919] h-[600px] justify-center items-center flex-col flex rounded-[8px]">
            <div className="min-w-[300px] bg-[#050505] rounded-t-[20px] py-[40px] min-h-[300px] relative flex flex-col items-center justify-center space-y-20 text-[64px]">
              <div className="space-y-2 flex flex-col items-center">
                <div className="rounded-full size-[150px] flex items-center justify-center bg-[#191919]">
                  🎉
                </div>
